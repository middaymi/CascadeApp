...
public class PerformanceEditModel {
     ...
     private void setDatatoList() {
        ...
        see at the edit panel*/
         String perfAthlets = "SELECT SEASON_PERFORMANCE.IDathlete, " +
         ...
         try {
             @Cleanup PreparedStatement pstmtAthletes = DBC.prepareStatement(perfAthlets);
             @Cleanup ResultSet rsAthletes = pstmtAthletes.executeQuery();
             ...
             while (rsAthletes.next()) {
                 ...
                 if (cicleTemp == 0) {
                     ...
                     actualSeason.setSeason(rsAthletes.getString(6));
                 }
             ...
             log.error("no  create list because of wrong query", ex);
         }
     }
     ...
     private void getAllAthletes() {
         ...
         perEditPage.getAthletesComboBox().removeAllItems();
         try {
             String allAthletes = "SELECT DISTINCT " +
                     "ATHLETE.ID, " +
                     "ATHLETE.Surname, ATHLETE.Name, " +
                     "ATHLETE.Middlename " +
             ...
             @Cleanup Statement stmtAllAthletes = DBC.createStatement();
             @Cleanup ResultSet rsAllAthletes = stmtAllAthletes.executeQuery(allAthletes);
             ...
             log.error("no get all athletes, to show in combobox", ex);
         }
     }
     ...
     public void addAthlete() {
         ...
         try {
             String addAthl = "INSERT INTO SEASON_PERFORMANCE " +
                     "VALUES (" +
                     actualSeason.getId() + ", " +
             ...
             //add to db
             @Cleanup PreparedStatement pstmtaddAthl = DBC.prepareStatement(addAthl);
             ...
             log.error("some problems with add athlete, add to db or viewing addAthlete()", ex);
         }
     }
     ...
     public void changeSeason() {
         ...
         try {
             ...
             actualSeason.setSeason(((Season) perEditPage.getSeasonComboBox().
                     getSelectedItem()).getSeason());
